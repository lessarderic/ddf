...
public class DownloadInfo {
    ...
    public long getBytesDownlowded() {
    ...
    public String toString() {
        return String.format(
                ...
                downloadId, file, status, bytesDownloaded, percentDownloaded, users);
    }
}